<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/cinexin/css/contenido.css" >
...
<%
    ...
    <label>Introduzca id_cartelera</label>
    <input class="id_cartelera" type="text" value="">
...
<table class="mostrartabla2 styled-table">
</table>

</article>
</main>

<script src="/cinexin/scripts/contenido.js"></script>
