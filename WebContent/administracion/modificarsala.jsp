...
if(request.getParameter("id") == null){
	...
	response.sendRedirect("/administracion/sala.jsp");
}

String id, id_cine, nombre;

id = (String)request.getAttribute("id");
id_cine = (String)request.getAttribute("id_cine");
...
<form action="modificarsala" method="post">
<input type='hidden' value="<%=id %>" name='id' />
<label>Introduce id_cine</label>
<input name="id_cine" type="text" value="<%=id_cine %>"/>
